...
function App() {
  ...
  return <main>
    ...
    <section className="hero"><div><p className="eyebrow">SIMPLE. EDITABLE. SCANNABLE.</p><h1>Make every scan count.</h1><p className="lede">Create beautiful QR codes for any link. Choose static for one-off sharing, or dynamic to edit the destination and track scans later.</p></div></section>
