...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    authEyebrow: "QR STUDIO ACCOUNT", welcomeBack: "Welcome back", createAccount: "Create your account", authDescription: "Save dynamic QR codes, change their destination, and monitor every scan.", email: "Email address", password: "Password", login: "Sign in", register: "Create account", google: "Continue with Google", googleUnavailable: "Google sign-in is not configured yet. Use email and password for now.", googleSigningIn: "Signing you in with Google…", googleFailed: "Google sign-in could not be completed.", or: "or continue with Google", haveAccount: "Already have an account? Sign in", needAccount: "New to QR Studio? Create an account", backToGenerator: "Back to generator", footer: "Build links that last.",
  },
  uz: {
